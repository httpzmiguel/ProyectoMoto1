...
public class EspacioParqueaderoTest {
    ...
    public void testEspacioIniciaLibre() {
        ...
        assertNull(espacio.getMotoAsignada(), "No debe haber moto asignada al inicio");
    }

    @Test
    public void testNumeroEspacio() {
        EspacioParqueadero espacio = new EspacioParqueadero(15);
        assertEquals(15, espacio.getNumero());
    }
    ...
    public void testOcuparEspacio() {
        ...
        assertEquals(moto, espacio.getMotoAsignada());
    }
    ...
    public void testLiberarEspacio() {
        ...
        assertNull(espacio.getMotoAsignada(), "La moto asignada debe ser nula al liberar");
    }
    ...
    public void testReasignarEspacio() {
        ...
        assertEquals("M2", espacio.getMotoAsignada().getPlaca());
    }
}
